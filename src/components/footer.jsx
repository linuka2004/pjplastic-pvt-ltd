...
export default function Footer() {
  return (
    <footer className="bg-[#eaf3ff]">
      {/* Main Footer */}
      <div className="max-w-screen-xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 text-gray-600">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed mb-6">
            PJ Plastic was founded with a goal of providing great quality
            plastic products at competitive prices.
          </p>

          <div className="flex gap-4">
            <a
              href="https://www.facebook.com/share/1BeBYopD8i/"
              target="_blank"
              rel="noreferrer"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white shadow-sm hover:shadow-md hover:-translate-y-1 transition-all"
            >
              <FaFacebook className="text-gray-700 w-5 h-5" />
            </a>
            <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=pjplastic.admin@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-full bg-white               shadow-sm hover:shadow-md hover:-translate-y-1 transition-all"
            >
           <BiLogoGmail className="text-gray-700 w-5 h-5" />
          </a>


            <a
              href="https://www.instagram.com/pjplastic"
              target="_blank"
              rel="noreferrer"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white shadow-sm hover:shadow-md hover:-translate-y-1 transition-all"
            >
              <FaInstagramSquare className="text-gray-700 w-5 h-5" />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-2">
              <span>📧</span>
              <span>pjplastic.admin@gmail.com</span>
            </li>
            <li className="flex items-start gap-2">
              <span>📞</span>
              <span>076 611 6847</span>
            </li>
            <li className="flex items-start gap-2">
              <span>📍</span>
              <span>
                1st Stage, Nalanda Ellawala Industrial Zone, Paradise, Kuruwita<br />Sri Lanka
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-blue-200">
        <div className="max-w-screen-xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <span>
            © {new Date().getFullYear()} PJ Plastic. All rights reserved.
          </span>
